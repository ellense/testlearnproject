<template>
  <el-dialog v-model="useReportStore().dialogFormReportProduct"
    title="Предварительный отчет по расчету c поставщиком по товарам" close-on-click-modal>
    <div class="reportTableWrapper__table">
      <vue-excel-editor v-model="tableDataReport" :localized-label="localizedExcelTableLabel" height="500px">
