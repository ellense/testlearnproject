<template>
    ...
    <el-scrollbar class="scrollTableRequirement">
        ...
        <el-table style="width: 100%; min-height:100px;" height="calc(100vh - 735px)" :data="kuRequirementList" border
            ...
            <el-table-column property="item_name" label="Наименование" show-overflow-tooltip />
            ...
            <el-table-column fixed="right" label="Операция" width="150" style="background-color: #ff9f9fdc;">
