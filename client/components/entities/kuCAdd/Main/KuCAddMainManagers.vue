<template>
  <el-scrollbar height="40vh">
    ...
    <el-dialog v-model="store.dialogFormManagersVisible" title="Выбор категорийныйх менеджеров для КУ" close-on-click-modal
      close-on-press-escape draggable width="765px">
      <el-scrollbar class="scrollTableFiltres">
        <el-table style="width: 730px" height="300" :data="tableData" border
          @selection-change="store.handleSelectionChangeManager" ref="multipleTableRef" v-loading="loading">
          <el-table-column type="selection" width="30" />
          <el-table-column property="id" label="Код" width="100" show-overflow-tooltip />
          <el-table-column property="group" label="Группа категорийных менеджеров" width="300" show-overflow-tooltip />
          <el-table-column property="description" label="Описание" width="300" show-overflow-tooltip />
        </el-table>
      </el-scrollbar>
