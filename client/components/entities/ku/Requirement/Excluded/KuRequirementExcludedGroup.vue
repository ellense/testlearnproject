  ...
  <el-dialog v-model="store.dialogFormCategoryExVisible" width="530px"
    ...
    <div class="selectCategory">
      ...
      <div>
        ...
        <el-select-v2 v-model="store2.valueProducer_nameEx" clearable filterable style="width: 500px; "
      ...
      <div>
        ...
        <el-select-v2 v-model="store2.valueBrand_nameEx" clearable filterable style="width: 500px"
...
watch(() => store2.producerExcluded, (producers: IProducer[]) => {
...
watch(() => store2.brandExcluded, (brands: IBrand[]) => {
...
const onProducerChange = async () => {
  store2.valueBrand_nameEx = "";
  store2.setFilterBrand('producer_name', store2.valueProducer_nameEx);
  if (store2.valueProducer_nameEx) { // Проверка, что выбрана торговая маркка
    ...
    console.log('Сброшен фильтр производителей:', store2.filterBrandExcluded);
...
const AddCategoryItem = async () => {
  if (store2.valueProducer_nameEx || value.value || store2.valueBrand_nameEx) {
    console.log("valueProducer_name", store2.valueProducer_nameEx);
    console.log("valueBrand_name", store2.valueBrand_nameEx);
    ...
    store.tableDataExRequirement.push({
      ...
      producer: store2.valueProducer_nameEx,
      brand: store2.valueBrand_nameEx,
    });
