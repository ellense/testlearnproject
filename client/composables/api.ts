...
import type { IParamServices, IServicesReturnData, IPlaceReturnData, IPricelistReturnData, IArticleReturnData, IService, IArticle, IServicePost, IArticlePost } from "~/utils/types/serviceTypes";
