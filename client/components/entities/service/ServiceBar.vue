<template>
  ...
  <el-dialog v-model="store.dialogFormServiceVisible" title="Новая услуга" close-on-click-modal
      close-on-press-escape draggable width="715px">
      <el-scrollbar class="scrollTableFiltres">
        <el-form >
          <el-form-item label-width="200" label="Код услуги" >
            <el-input v-model="store.newService_id" placeholder="Введите код" style=" width: 300px;" size="small"></el-input>
          </el-form-item>
          <el-form-item label-width="200" label="Наименование услуги" prop="newVendorId">
            <el-input v-model="store.newService_name" placeholder="Введите наименование" style=" width: 300px;" size="small"></el-input>
          </el-form-item>
        </el-form>
      </el-scrollbar>
      <template #footer>
...
const saveRow = async () => {
  tableData.value.push({ service_code: store.newService_id , service_name: store.newService_name, });
