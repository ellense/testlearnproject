...
const saveRow = async () => {
  tableData.value.push({ article_id: store.newPriceArticle_id, article_name: store.newPriceArticle_name, measure_unit: store.newPricMeasure_unit, cost: store.newPriceCost, expiration_date: store.newPriceExpiration_date, date: store.newPriceDate,  });
